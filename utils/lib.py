...
class AudioDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #   if (1) not loaded, or (2) need new transform
            ...
            audio.compute_mfcc(n_mfcc=39) # return mfcc
...
class AudioClass(object):
    def __init__(self, 
                 ...
                 n_mfcc=39):  # Updated n_mfcc to 39
        if filename:
        ...
        self.mfcc = None
        self.n_mfcc = n_mfcc  # Updated n_mfcc to 39
    ...
    def compute_mfcc(self, n_mfcc=39):  # Updated n_mfcc to 39
...
if 1: # Frequency domain processings (on mfcc)
    ...
    def compute_mfcc(data, sample_rate, n_mfcc=39):  # Updated n_mfcc to 39
    # Extract MFCC features
    # https://librosa.github.io/librosa/generated/librosa.feature.mfcc.html
    	mfcc = librosa.feature.mfcc(
        y=data,
        sr=sample_rate,
        n_mfcc=n_mfcc,   # Updated n_mfcc to 39
   	 )
    	return mfcc 
